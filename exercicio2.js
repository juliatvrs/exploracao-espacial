const imagens = [
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/01-modelo-artistico-da-sonda.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/02-lancamento-atlas-v-em-2017.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/03-distanciamento-da-sonda-da-terra.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/04-aproximacao-da-sonda-ao-bennu-em-2018.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/05-mapeamento-do-asteroide.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/06-local-de-pouso.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/07-touch-and-go-e-detritos-suspensos-em-2020.webp",
  ...
  {
    arquivo: "https://fegemo.github.io/cefet-web/images/osiris/08-sonda-distanciando-e-voltando-para-terra.webp",
...
let imagemSlide = document.querySelector('#slide');
let botaoProximo = document.querySelector('#proximo');
let botaoAnterior = document.querySelector('#anterior');


function exibirImagem () {
  imagemSlide.src = imagens[indiceAtual].arquivo;
  imagemSlide.alt = imagens[indiceAtual].descricao;
};
